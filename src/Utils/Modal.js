...
export default function ModalBase() {
    ...
    return (<React.Fragment>
        <Dialog open={modal} onClose={handleClose} aria-labelledby="form-dialog-title">
            ...
            <DialogContent>
                <TextField value={state !== undefined && state.title} id="outlined-textarea" label="Title"
                           placeholder="Write your title" className={classes.textField} margin="normal"
                           variant="outlined" fullWidth onChange={(e) => handleChange('title', e)}/>
                <FormControl variant="outlined" className={classes.formControl}>
                    <InputLabel ref={inputLabel} htmlFor="outlined-age-native-simple">
                        Category
                    </InputLabel>
                    <Select native value={state !== undefined && state.category}
                            onChange={(e) => handleChange('category', e)} labelWidth={labelWidth} inputProps={{
                        name: 'age',
                ...
                <TextField value={state !== undefined && state.message} id="outlined-textarea"
                           label="Write your Message" placeholder="Write your note" multiline
