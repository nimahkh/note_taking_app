...
function CreateNote() {
    ...
    return (<React.Fragment>
        <Typography variant="h5" align="center" color="primary" gutterBottom noWrap>Add a new
            Note</Typography>

        <TextField id="outlined-textarea" label="Title" placeholder="Write your title" className={classes.textField}
        ...
        <FormControl variant="outlined" className={classes.formControl}>
            ...
            <Select native value={state.category} onChange={(e) => handleChange('category', e)}
        ...
        <FormControl variant="outlined" className={classes.formControl}>
            ...
            <Select native value={state.notebook} onChange={(e) => handleChange('notebook', e)}
                    labelWidth={labelWidth} inputProps={{
                name: 'notebook',
