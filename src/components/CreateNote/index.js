...
function CreateNote() {
  ...
  const [state, setState] = React.useState({id: 0, category: '', message: '', title: ''});
  ...
  **/
  ...
  return (<React.Fragment>
    ...
    <TextField id="outlined-textarea" label="Title" placeholder="Write your title" className={classes.textField} margin="normal" variant="outlined" fullWidth onChange={(e) => handleChange('title', e)}/>
    ...
    <TextField id="outlined-textarea" label="Write your Message" placeholder="Write your note" multiline className={classes.textField} margin="normal" variant="outlined" onChange={(e) => handleChange('message', e)} rows={10} fullWidth/>
