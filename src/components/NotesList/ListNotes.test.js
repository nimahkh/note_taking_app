...
let allNotes=[];
beforeEach(() => {
  localStorage.setItem('notes',"[{\"category\":\"Work\",\"message\":\"ddsaf\",\"title\":\"wed\"},{\"category\":\"Friends\",\"message\":\"kkjkjkkjkjk\",\"title\":\"jj\"}]")
...
describe('List the Notes',()=>{
  ...
  test("List notes must be 0",()=>{
    const wrapper= mount(<IncludingProvider><NotesList/></IncludingProvider>)
